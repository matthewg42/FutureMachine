...
int8_t AltLeverClass::addRange(int start, int end)
{
...
void AltLeverClass::begin(uint8_t threshold, uint8_t delay)
{
...
int8_t AltLeverClass::value()
{
    return _state;
}

int8_t AltLeverClass::_value()
{
    // 0 <= raw < 1024
...
void AltLeverClass::setState(int8_t newState)
{
